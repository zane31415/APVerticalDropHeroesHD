...
def main():
    ...
    a("// DeathLink amnesty: send one death in every ap_death_amnesty,")
    a("// after the first ap_death_buffer have been swallowed outright.")
    a(f"global.ap_death_amnesty = {defs.DEFAULT_DEATH_AMNESTY};")
    a(f"global.ap_death_buffer = {defs.DEFAULT_DEATH_AMNESTY_BUFFER};")
    a(f"global.ap_max_death_amnesty = {defs.MAX_DEATH_AMNESTY};")
